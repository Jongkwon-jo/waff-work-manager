...
export default function HomePage() {
  ...
  const cards = [
    ...
    },
    {
      href: "/daily-report",
      title: "Daily Report",
      description: "WBS · 이메일 · 카카오톡을 통합 분석해 5섹션으로 정리합니다.",
      icon: ListChecks,
      visible: isAdmin || pagePermissions.dailyReport,
      tone: "from-teal-50 via-cyan-50/60 to-white",
    ...
    },
    {
      ...
      title: "법인차량운행/정비이력",
      description: "법인차량의 운행기록과 정비이력을 차량별로 관리합니다.",
      icon: CarFront,
      visible: true,
